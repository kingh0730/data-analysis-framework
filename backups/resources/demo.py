...
import zk2861api_super as zk2861api

SECURE_KEY = ''
zk2861api.ENCRYPT_ENABLE = 1
DEMO_GET_DATA_DATE = '2020-04-30'
...
def demo_api_get_gov_indexs_data():
    ...
    api_ret = zk2861api.api_get_gov_indexs_data(
        SECURE_KEY, None, [17, 18], DEMO_GET_DATA_DATE, timeout=60)
    pass
...
def demo_api_get_govs_index_data():
    ...
    api_ret = zk2861api.api_get_govs_index_data(
        SECURE_KEY, None, 18, DEMO_GET_DATA_DATE, timeout=60)
    pass
